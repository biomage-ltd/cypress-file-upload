...
function getFileBlobAsync(fileName, simulatedFilePath = null, fileContent, mimeType, encoding, window, lastModified) {
...
function resolveFile(fixture, window, simulatedFilePath = null) {
  const {
    filePath,
    encoding,
    mimeType,
